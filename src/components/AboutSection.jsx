        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 items-start">
          ...
          <div className="lg:col-span-1">
            <div className="relative group">
              <div className="aspect-square max-w-xs mx-auto lg:max-w-none overflow-hidden rounded-2xl shadow-2xl shadow-primary/10 border-2 border-white/20 relative z-20 bg-gradient-to-br from-white/10 to-transparent backdrop-blur-sm">
                <img
                  src={Profile}
                  alt="Wiam Frikal"
                ...
                <div className="relative p-8 rounded-xl bg-transparent backdrop-blur-sm">
                  <div className="ml-6">
                    <p className="text-lg leading-relaxed text-foreground mb-4 italic">
                      Junior full-stack web developer with a strong foundation
                      in building modern, responsive, and user-focused web
                      applications. I work primarily with the JavaScript
                      ecosystem, including React for front-end interfaces and
                      Node.js/Express for back-end development.
                    </p>
                    <p className="text-lg leading-relaxed text-foreground italic">
                      I enjoy creating clean, efficient code and learning new
                      technologies that help me improve both performance and
                      scalability. Curious, motivated, and detail-oriented, I
                      thrive on solving problems, building real projects, and
                      continuously developing my skills to grow as a full-stack
                      developer.
                    </p>
                  </div>
                </div>
